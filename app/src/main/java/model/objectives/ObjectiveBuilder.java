...
public interface ObjectiveBuilder {
	 ...
	 */
	ObjectiveBuilder setMaxMoves(final int num);
	 ...
	 */
	ObjectiveBuilder setChallenge(final Optional<Challenge> challenge);

	/**
	 * Sets the text of the {@link Objective}
	 *
	 * @param text the string that specifies the the text that explain the {@link Objective}
	 * @return this {@link ObjectiveBuilder}, with the objectiveText modified
	 */
	ObjectiveBuilder setObjectiveText(final String text);
